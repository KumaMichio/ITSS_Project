...
import com.truonggiang.vnpay.common.constants.VnPayConstant;
import com.truonggiang.vnpay.common.utils.VnPayHelper;
...
public class OrderPaymentService {
    public Map<String, Object> createOrder(HttpServletRequest request, OrderRequestDTO orderRequestDTO)
        ...
        Map<String, Object> payload = new HashMap<>() {
            {
                ...
                put("vnp_Locale", orderRequestDTO.getLanguage() != null ? orderRequestDTO.getLanguage()
                        : VnPayConstant.VNP_LOCALE);
        ...
        if (orderRequestDTO.getBankCode() != null && !orderRequestDTO.getBankCode().isEmpty()) {
            payload.put("vnp_BankCode", orderRequestDTO.getBankCode());
        }
